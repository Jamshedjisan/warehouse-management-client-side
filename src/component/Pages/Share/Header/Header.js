        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto">
              ...
              {user ? (
                <Nav.Link className="nav-item" as={Link} to="/addItems">
                  Add Item
                </Nav.Link>
              ) : (
                ""
              ...
              {user ? (
                <Nav.Link className="nav-item" as={Link} to="/manage">
                  Manage Items
                </Nav.Link>
              ) : (
                ""
              ...
              {user ? (
                <Nav.Link className="nav-item" as={Link} to="/myItems">
                  My items
                </Nav.Link>
              ) : (
                ""
              )}
              <Nav.Link className="nav-item" as={Link} to="/blog">
                Blog
              </Nav.Link>
              {user ? (
