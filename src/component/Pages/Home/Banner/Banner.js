      ...
      <Carousel fade>
        <Carousel.Item>
          ...
          <Carousel.Caption>
            ...
            <p>
              Treat your space like an empty canvas,
              <br /> filled with potential
            </p>
            <button as={Link} to="/about" className="btn btn-one">
              Read More
            </button>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
          ...
          <Carousel.Caption>
            ...
            <p>
              Good design is good business. Not only does it attract attention,
              <br /> it spurs people to take action.
            </p>
            <button as={Link} to="/about" className="btn btn-one">
              Read More
            </button>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption>
            ...
            <p>
              ...
              <br /> Values determine the future
            </p>
            <button as={Link} to="/about" className="btn btn-one">
              Read More
            </button>
