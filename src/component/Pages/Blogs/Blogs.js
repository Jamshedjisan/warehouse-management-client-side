          ...
          <div className="blog-info">
            ...
            <div className="j-ans-area">
              ...
              <div className="j-ans-info">
                <p>
                  1. <FaArrowRight /> Javascript is a programming language that
                  is used for writing scripts on the website.
                </p>
                <p>
                  2. <FaArrowRight /> Javascript can only be run in the
                  browsers.
                </p>
                <p>
                ...
                <p>
                  4. <FaArrowRight /> Javascript is capable enough to add HTML
                  and play with the DOM.
                </p>
                <p>
                  5. <FaArrowRight /> JavaScript is mainly used for client side
                  stuff in an web site or page.
                </p>
                <p>
            ...
            <div className="n-ans-area">
              ...
              <div className="n-ans-info">
                ...
                <p>
                  4. <FaArrowRight /> Nodejs does not have capability to add
                  HTML tags.
                </p>
                <p>
                  5. <FaArrowRight />
                ...
                <p>
                  6. <FaArrowRight /> Some of the Nodejs modules are Lodash,
                  express etc. These modules are to be imported from npm.
                </p>
                <p>
                  7. <FaArrowRight />
            ...
            <div className="node-ans-area">
              ...
              <div className="j-ans-info">
                <p>
                  ...
                  servers,data-intensive due to its single-threaded nature. It's
                  used for traditional web sites and back-end API services. Node
                  JS is best suited for real-time collaborative drawing or
            ...
            <div className="mongodb-ans-area">
              ...
              <div className="mong-db-ans-info">
                <p>
                  ...
                  data is document-centric and doesn't fit well into the schema
                  of a relational database, when you need to accommodate massive
          ...
          <div className="blog-info">
            ...
            <div className="n-ans-area">
              ...
              <div className="n-ans-info">
                ...
                <p>
                  4. <FaArrowRight /> These databases are not so good for
                  complex queries
                </p>
                <p>
                  5. <FaArrowRight />
          ...
          <div className="blog-info">
            ...
            <div className="jwt-ans-area">
              ...
              <div className="jwt-db-ans-info">
                <p>
                  1.Users will start by authenticating with a username and
                  password managed by Auth0.{" "}
                </p>
                <p>
                  2.Once authenticated, the client will receive a JWT
                  representing an access token.{" "}
                </p>
                <p>
